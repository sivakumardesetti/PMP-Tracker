...
var PickerAdapterContext = React29.createContext(null);
...
var LocalizationProvider = function LocalizationProvider2(inProps) {
  ...
  } = React29.useContext(PickerAdapterContext) ?? {
    utils: void 0,
    adapter: void 0,
    localeText: void 0
  };
  ...
  const localeText = React29.useMemo(() => _extends({}, themeLocaleText, parentLocaleText, inLocaleText), [themeLocaleText, parentLocaleText, inLocaleText]);
  const adapter = React29.useMemo(() => {
    if (!DateAdapter) {
      if (parentAdapter) {
...
`));
  ...
  const defaultDates = React29.useMemo(() => {
    if (!adapter) {
      return null;
    }
    return {
