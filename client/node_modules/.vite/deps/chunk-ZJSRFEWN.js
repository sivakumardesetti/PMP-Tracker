import {
  ...
  require_shim,
  warnOnce
} from "./chunk-CFI2MBAS.js";
import {
  NoSsr_default,
  useMediaQuery_default
} from "./chunk-PTAMRFSH.js";
import {
  Button_default,
  HTMLElementType,
  IconButton_default,
...
} from "./chunk-RPDVMNLM.js";
import {
  ownerWindow,
  useEventCallback_default,
  useForkRef
} from "./chunk-OAPL7I5Y.js";
import {
  useThemeProps
} from "./chunk-J6YJLRL6.js";
import {
  _extends,
  clsx_default,
  composeClasses,
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React60 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef11 = React60.useRef, useEffect16 = React60.useEffect, useMemo10 = React60.useMemo, useDebugValue = React60.useDebugValue;
...
var useSelectorSeries = createSeriesSelectorsOfType("line");
var useSelectorSeriesContext = createAllSeriesSelectorOfType("line");
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React20.useState(typeof window !== "undefined" || false);
  React20.useEffect(() => {
    setIsHydrated(true);
  }, []);
  return isHydrated;
...
function ChartsText(props) {
  ...
  const wordsByLines = React22.useMemo(() => getWordsByLines({
    style,
...
var consumeThemeProps = (name, options, InComponent) => React27.forwardRef(function ConsumeThemeInternal(props, ref) {
  const themedProps = useThemeProps({
    props,
  ...
  const OutComponent = React27.forwardRef(InComponent);
...
function useColorProcessor(seriesType) {
  const store = useStore();
  const seriesConfig5 = useSelector(store, selectorChartSeriesConfig);
  const colorProcessors = React30.useMemo(() => {
    const rep = {};
...
function ChartsTooltipContainer(inProps) {
  ...
  const anchorEl = React33.useMemo(() => ({
  ...
  return (0, import_jsx_runtime11.jsx)(NoSsr_default, {
    children: isOpen && (0, import_jsx_runtime11.jsx)(ChartsTooltipRoot, _extends({
      className: classes?.root,
      open: isOpen,
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  ...
  return React35.forwardRef(ConsumeSlotsInternal);
};
...
}, React37.forwardRef(function ChartsLegend2(props, ref) {
  ...
  return (0, import_jsx_runtime15.jsx)(RootElement, _extends({
    ...
    children: data.items.map((item, i) => {
      return (0, import_jsx_runtime15.jsx)("li", {
        ...
        "data-series": item.id,
        children: (0, import_jsx_runtime15.jsxs)(Element2, {
...
function ChartsYHighlight(props) {
  ...
  return axisYValues.map(({
    ...
    return (0, import_jsx_runtime19.jsxs)(React41.Fragment, {
      children: [isBandScaleY && yScale(value) !== void 0 && (0, import_jsx_runtime19.jsx)(ChartsAxisHighlightPath, {
...
function ChartsXHighlight(props) {
  ...
  return axisXValues.map(({
    ...
    return (0, import_jsx_runtime20.jsxs)(React42.Fragment, {
      children: [isBandScaleX && xScale(value) !== void 0 && (0, import_jsx_runtime20.jsx)(
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime21.jsxs)(React43.Fragment, {
...
var ChartsSlotsContext = React51.createContext(null);
...
function ChartsSlotsProvider(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(ChartsSlotsContext.Provider, {
    value,
    children
  });
}
...
var _excluded17 = ["children", "localeText", "plugins", "seriesConfig", "slots", "slotProps"];
...
function ChartDataProvider(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(ChartProvider, _extends({}, chartProviderProps, {
    children: (0, import_jsx_runtime30.jsx)(ChartsLocalizationProvider, {
      localeText,
      children: (0, import_jsx_runtime30.jsx)(ChartsSlotsProvider, {
        slots,
        slotProps,
  ...
  return (0, import_jsx_runtime31.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime31.jsxs)(React54.Fragment, {
        children: [(0, import_jsx_runtime31.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime31.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime32.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
...
function ChartsContinuousGradientObjectBound(props) {
  ...
  const keyPrefix = `${extremumValues[0]}-${extremumValues[1]}-`;
  return (0, import_jsx_runtime33.jsx)("linearGradient", _extends({
    id: gradientId
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime33.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime34.jsxs)("defs", {
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if (colorMap?.type === "piecewise") {
        return (0, import_jsx_runtime34.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorMap,
          size: svgHeight,
      ...
      if (colorMap?.type === "continuous") {
        return (0, import_jsx_runtime34.jsxs)(React57.Fragment, {
          children: [(0, import_jsx_runtime34.jsx)(ChartsContinuousGradient, {
            ...
            gradientId,
            direction: "y"
          }), (0, import_jsx_runtime34.jsx)(ChartsContinuousGradientObjectBound, {
            isReversed: reverse2,
            colorScale,
            colorMap,
      ...
      if (colorMap?.type === "continuous") {
        return (0, import_jsx_runtime34.jsx)(ChartsContinuousGradientObjectBound, {
          colorScale,
          colorMap,
          gradientId: objectBoundGradientId
...
var ChartsSurface = React58.forwardRef(function ChartsSurface2(inProps, ref) {
  const store = useStore();
  const {
    width: svgWidth,
    height: svgHeight
  ...
  return (0, import_jsx_runtime35.jsxs)(ChartsSurfaceStyles, _extends({
    ownerState: {
      width: propsWidth,
      height: propsHeight
    },
    ...
    ref: handleRef,
    children: [title && (0, import_jsx_runtime35.jsx)("title", {
      children: title
    }), desc && (0, import_jsx_runtime35.jsx)("desc", {
      children: desc
    }), (0, import_jsx_runtime35.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
function ChartsWrapper(props) {
  ...
  return (0, import_jsx_runtime36.jsx)(Root3, {
    ref: chartRootRef,
    ownerState: props,
    sx,
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZJSRFEWN.js.map
